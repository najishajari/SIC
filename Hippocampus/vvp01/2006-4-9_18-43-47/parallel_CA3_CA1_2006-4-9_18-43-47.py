...
for i in np.arange(300):
    ...
    #print (X_window)
    #print( np.vstack((Y_window,X_window)).T)
    ...
    #print (GC_XY[30][0]['ssr_ftest'])
    #print (GC_XY[1],';',GC_YX[1],file=f_GC)

    #low-passing to take LFP only
    #Sx=pmtm(X_window,NW=2.5,show=False)
    #Sy=pmtm(Y_window,NW=2.5,show=False)
    
    #res_SIC=delta_estimator_3(Sy/Sx,Sx),delta_estimator_3(Sx/Sy,Sy)
